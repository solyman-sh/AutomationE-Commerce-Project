describe("Register Before Checkout", () => {
  ...
  it("Register Before Checkout ", () => {
    ...
    cy.get("input[data-qa='signup-email']").type("jordiporn98@gmail.com");
    ...
    cy.get("section[id='cart_items'] div:nth-child(2) h2:nth-child(1)").should(
      "have.text",
      "Address Details"
    );
    cy.get("textarea[name='message']").type(
      "Amar sonar bangle ami tomai valobashi "
    );
    cy.get(".btn.btn-default.check_out").click();
    cy.wait(3000);
